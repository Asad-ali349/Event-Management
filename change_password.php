                  ...
                  <form method="POST" action="includes/routes.php">
                    <div class="row">
                        ...
                        <div class="form-group">
                          <label class="bmd-label-floating">Previous Username</label>
                          <input type="text" name="previousUsername" class="form-control" required>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">Confirm New Passowrd</label>
