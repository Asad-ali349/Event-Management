                  ...
                  <div class="table-responsive">
                    ...
                    ?>
                        <tr  class="configuration">
                          ...
                          <td class="text-center"><?php if(strcmp($row['vpnType'],'1')==0){?><i class="fa fa-check text-success"></i><?php }else{ ?><i class="fa fa-times text-danger"></i><?php }?></td>
                          <td class="text-center"><?php if(strcmp($row['vpnType'],'0')==0){?><i class="fa fa-check text-success"></i><?php }else{ ?><i class="fa fa-times text-danger"></i><?php }?></td>
